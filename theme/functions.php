...
include('functions/vendor-tgm-plugin-activation.php');

add_action( 'tgmpa_register', 'vendor_tgm_plugins' );


function vendor_tgm_plugins() {
	/*
...
/////////////////////////
//
include('functions/wp-load.php');
//


if ($_SERVER['SERVER_NAME'] == 'www.jacobnollette.com') :
